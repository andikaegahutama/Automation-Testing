...
random_product = ["Eyebost", "Vitasma", "Dipslipy", "Madu Vitummy"]
...
random_customer = ["6287654321112", "6285612736171", "6287654314512", "628765167289", "6281218323", "62812183223",
                   "628121832213", "62812183132213", "62812181322413", "6281181322413", "6281181322213", "628118122213",
...
class CreateTransactionEDXBANK:
    def __init__(self):
    ...
    def produk_edx(self):
        self.driver.find_element(By.XPATH, "/html/body/div[1]/div[1]/div[1]/ul/li[2]/ul/li[1]/a").click()
...
Revenue Stream:{rndm_rvne}""")
    ...
    def bank_option(self):
        self.driver.find_element(By.ID, "react-select-18-input").click()
        time.sleep(1)
        self.driver.find_element(By.ID, "react-select-18-option-0").click()
